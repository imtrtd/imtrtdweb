...
const projects = [
  { n: "01", title: "NAMENLOS", type: "TATTOO STUDIO / BOOKING", color: "acid", href: "/work/namenlos", note: "Concept case study: identity-led booking flow with a raw visual language." },
  { n: "02", title: "NACHTWERK", type: "EVENT SERIES / TICKETS", color: "violet", href: "/work/nachtwerk", note: "Concept case study: an atmospheric event page built around line-ups and conversion." },
  { n: "03", title: "KIOSK 23", type: "CAFÉ / LOCAL COMMERCE", color: "orange", href: "/work/kiosk-23", note: "Concept case study: a compact digital home for a small space with a loud point of view." },
];
  ...
  return (
    <main>
      ...
      <section className="manifesto section-pad">
        ...
        <h2>ONE PERSON.<br />FULL <em>SYSTEM.</em></h2>
        <div className="manifesto-copy">
          <p>From first sketch to deployment: strategy, interface, code and motion developed as one continuous product system.</p>
          <span className="mono">[ DESIGN × DEVELOPMENT × VISUALIZATION ]</span>
        </div>
      </section>

      <section className="projects" id="work">
        <div className="section-head section-pad"><p className="eyebrow">// SELECTED WORK</p><span className="mono">03 CONCEPT CASES / 03 SYSTEMS</span></div>
        {projects.map((project) => (
          <a className={`project ${project.color}`} href={project.href} key={project.title} aria-label={`Open ${project.title} concept case study`}>
        ...
        <div className="work-archive section-pad">
          <p className="mono">ALL CASE STUDIES ARE CLEARLY LABELED CONCEPT / PLACEHOLDER WORK.</p>
          <a className="systems-link" href="/systems">OPEN THE REFERENCE SYSTEMS <span>↗</span></a>
        </div>
      </section>

      <section className="services section-pad" id="services">
        <div><p className="eyebrow">// CAPABILITIES</p><h2>FROM IDEA<br />TO <span>ONLINE.</span></h2></div>
        <div className="service-list">
          {[['01','WEB DESIGN','Visual systems, responsive interfaces and prototypes.'],['02','DEVELOPMENT','Fast, accessible builds with clean interactions.'],['03','VISUALIZATION','Presentations, product concepts and visual systems from text.'],['04','CARE & EVOLUTION','Launch support, improvements and new releases.']].map(([n,title,desc]) => <div className="service" key={n}><b>{n}</b><h3>{title}</h3><p>{desc}</p></div>)}
        </div>
      </section>
      ...
      <section className="changelog section-pad" id="changelog">
        ...
        <div className="change-intro"><p className="eyebrow">// BUILD IN PUBLIC</p><h2>CHANGE<br /><span>LOG_</span></h2><p>The site evolves with the work. This log tracks the visible product and design changes.</p></div>
      ...
      <footer className="footer section-pad" id="contact">
        ...
        <div className="footer-row mono">
          ...
          <span><a href="https://t.me/IMTRTD" target="_blank" rel="noreferrer">TELEGRAM ↗</a> · <a href="https://www.instagram.com/imtryingtodesign/" target="_blank" rel="noreferrer">INSTAGRAM ↗</a></span>
